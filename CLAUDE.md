...
- **Deploy:** Cloudflare Pages (auto-deploy en push a main; sitio estático, sin build, publica la raíz `/`). NO usar `wrangler.toml` (lo trata como Worker y rompe el build).
